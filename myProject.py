...
# You can load data from sklearn.datasets
data = pd.read_csv("//home//knez//Documents//brest_cancer.csv",header=0,encoding="utf-8") # this is just my path you have to define yours!
